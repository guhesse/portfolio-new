const projects = [
    {
        ...
        image: require('../public/assets/videos/alienware-bf-2024/thumb.jpg'),
        video: require('../public/assets/videos/alienware-bf-2024/video.mp4'),
        details: [
            require('../public/assets/videos/alienware-bf-2024/detail1.jpg'),
            require('../public/assets/videos/alienware-bf-2024/detail2.jpg'),
            require('../public/assets/videos/alienware-bf-2024/detail3.jpg'),
            require('../public/assets/videos/alienware-bf-2024/detail4.jpg'),
            require('../public/assets/videos/alienware-bf-2024/detail5.jpg')
        ],
    ...
    },
    {
        ...
        image: require('../public/assets/videos/dell-ofertas-todo-dia-q2-w1/thumb.jpg'),
        video: require('../public/assets/videos/dell-ofertas-todo-dia-q2-w1/video.mp4'),
        details: [
            require('../public/assets/videos/dell-ofertas-todo-dia-q2-w1/detail1.jpg'),
            require('../public/assets/videos/dell-ofertas-todo-dia-q2-w1/detail2.jpg'),
            require('../public/assets/videos/dell-ofertas-todo-dia-q2-w1/detail3.jpg'),
            require('../public/assets/videos/dell-ofertas-todo-dia-q2-w1/detail4.jpg'),
            require('../public/assets/videos/dell-ofertas-todo-dia-q2-w1/detail5.jpg'),
            require('../public/assets/videos/dell-ofertas-todo-dia-q2-w1/detail6.jpg')
        ],
        description: "The 'Marble Elegance' project is a captivating introduction to the Motorola Edge 50.",
        tags: "Video, Animation, Motion Graphics"
    },
    {
        ...
        image: require('../public/assets/videos/dell-bf-2024/thumb.jpg'),
        video: require('../public/assets/videos/dell-bf-2024/video.mp4'),
        details: [
            require('../public/assets/videos/dell-bf-2024/detail2.jpg'),
            require('../public/assets/videos/dell-bf-2024/detail3.jpg'),
            require('../public/assets/videos/dell-bf-2024/detail4.jpg'),
            require('../public/assets/videos/dell-bf-2024/detail5.jpg'),
            require('../public/assets/videos/dell-bf-2024/detail6.jpg'),
            require('../public/assets/videos/dell-bf-2024/detail7.jpg')
        ],
        description: "The 'Marble Elegance' project is a captivating introduction to the Motorola Edge 50.",
        tags: "Video, Animation, Motion Graphics"
    },
    {
        ...
        image: require('../public/assets/code/alienware-esquenta-bf-2024/thumb.jpg'),
    ...
    },
    {
        ...
        image: require('../public/assets/code/dell-tecnologia-essencial-2024/thumb.jpg'),
    ...
    },
    {
        ...
        image: require('../public/assets/carousel/dell-carousel-q4fy2025/thumb.jpg'),
        code: '/assets/code/dell-tecnologia-essencial-2024/detail/716153-index.html',
        details: [
            // 1200x1200
