...
window.onload = function () {
	...
	tl.set(banner, { visibility: "visible" })
		...
		.to(".f2-bg, .bg-pattern4, .f4-pro, .txt-con-f4", { autoAlpha: 0 }, "frame4+=2.7")

		/*frame five*/
		.add("frame5", "frame4+=3")
		.from(".f5-bg, .cta-4, .dell-logo-f5", .3, { autoAlpha: 0 }, "frame5")
...
function calculateLogoSizes() {
	try {
		...
		var dellLogof5 = document.getElementsByClassName('dell-logo-f5')[0];
