...
window.onload = function () {
	...
	tl.set(banner, { visibility: "visible" })
		...
		.from(" .proname-txt-1", { autoAlpha: 0 }, "frame1+=1")
		.from(".title1 .letter", .3, { autoAlpha: 0, ease: 'Sine.easeIn', stagger: 0.02 }, "frame1+=.5")
		.to(".badge1, .proname-txt-1, .title1", { autoAlpha: 0 }, "frame1+=2.5")
		...
		/*frame five*/
		.add("frame5", "frame4+=3")
		.from(".f5-bg, .cta-4, .dell-logo-f5, .funding-box-f5", .3, { autoAlpha: 0 }, "frame5")
