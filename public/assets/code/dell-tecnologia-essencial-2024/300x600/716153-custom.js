...
window.onload = function () {
	...
	tl.set(banner, { visibility: "visible" })
		...
		.to(".f1-pro, .cta-1, .dell-logo, .funding-box-f1", { autoAlpha: 0 }, "frame1+=2.7")
		...
		.from(".cta-2, .bundle-txt-2", { autoAlpha: 0 }, "frame2+=.3")
		...
		.to(".dell-element-4", .75, { top: "60%" }, "frame4+=.3")
		...
		/*frame five*/
		.add("frame5", "frame4+=3")
		.to(".funding-box-f1, .dell-logo, .cta-1", .3, { autoAlpha: 1 }, "frame5")
		.from(".f5-bg, .bundle-txt-5, .dell-logo-f5", .3, { autoAlpha: 0 }, "frame5")
	...
	/*roll over*/
	// 	.from("#roll-cta", { autoAlpha: 0, x: "100%" }, "frame5+=1.5")
	// 	.from("#rolltext", { autoAlpha: 0 }, "frame5+=1.5")
	// 	.from("#legal-text", { autoAlpha: 0 }, "frame5+=1.5")
