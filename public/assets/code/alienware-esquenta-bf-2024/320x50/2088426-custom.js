...
window.onload = function () {
	...
	tl.set(banner, { visibility: "visible" })
		...
		.to(".life-imgf1, .aw-logo, .funding-box, .cta", { autoAlpha: 0 }, "frame1+=2.5")
		.to(".f1-bg,.f1-header", { autoAlpha: 0 }, "frame1+=2.7")
		.to(".cta", { bottom: "30%" }, "frame1+=2.7")

		/*frame two*/
		.add("frame2", "frame1+=3")
		.to(".cta", { autoAlpha: 1 }, "frame2")
		...
		.to(".f2-header", { top: "-100%" }, "frame2+=3")



		/*frame three*/
		.add("frame3", "frame2+=3")
		.from(".f3-header", { top: "100%" }, "frame3")
		...
		/*frame four*/
		.add("frame4", "frame3+=3")
		.from(".f4-bg, .f4-header", { autoAlpha: 0 }, "frame4")
		.from(".life-imgf4", { autoAlpha: 0 }, "frame4+=.3")
		...
		.to(".f4-bg, .life-imgf4, .f4-header, .cta", { autoAlpha: 0 }, "frame4+=2.7")
		.to(".cta", { bottom: "7%" }, "frame4+=2.9")
		.to(".funding-copy", { color: "#000" }, "frame4+=2.5")
		...
		.from(".f5-bg, .f5-header, .funding-box2", { autoAlpha: 0 }, "frame5")
