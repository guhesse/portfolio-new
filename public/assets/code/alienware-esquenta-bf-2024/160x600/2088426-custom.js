...
var tl = gsap.timeline({ repeat: 0, repeatDelay: 1.65 });
gsap.defaults({
	ease: Quad.easeInOut,
	force3D: false,
	duration: 0.3
...
window.onload = function () {
	...
	tl.set(banner, { visibility: "visible" })
		...
		/*frame one*/
		.from(".aw-logo, .funding-box, .cta", { autoAlpha: 0 }, "frame1")
		.from(".title1", { autoAlpha: 0, stagger: 0.2, left: "-15%" }, "frame1+=.3")
		.to(" .title1", { autoAlpha: 0 }, "frame1+=2.5")
		.to(".life-imgf1", { autoAlpha: 0 }, "frame1+=2.5")
		.to(".f1-bg, .f1-header, .aw-logo, .funding-box, .cta", { autoAlpha: 0 }, "frame1+=2.7")

		/*frame two*/
		.add("frame2", "frame1+=3")
		.from(".f2-bg, .f2-header, .cta2", { autoAlpha: 0 }, "frame2")
		...
		.to(".f4-bg, .life-imgf4, .f4-header, .cta2", { autoAlpha: 0 }, "frame4+=2.7")
