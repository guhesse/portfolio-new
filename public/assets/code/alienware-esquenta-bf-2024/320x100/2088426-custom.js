...
window.onload = function () {
	...
	tl.set(banner, { visibility: "visible" })
		...
		.to(".life-imgf1, .cta, .aw-logo, .funding-box", { autoAlpha: 0 }, "frame1+=2.5")
		.to(".f1-bg,.f1-header", { autoAlpha: 0 }, "frame1+=2.7")

		/*frame two*/

		.add("frame2", "frame1+=3")
		.to(".aw-logo", { left: "3%" }, "frame2")
		.from(".f2-bg, .cta2, .f2-header", { autoAlpha: 0 }, "frame2")
		...
		.to(".f2-header", { top: "-50%" }, "frame2+=2.7")



		/*frame three*/
		.add("frame3", "frame2+=3")
		.from(".f3-header", { top: "50%" }, "frame3")
		...
		.to(".life-imgf4, .cta2, .f4-header", { autoAlpha: 0 }, "frame4+=2.7")
		.to(".funding-copy", { color: "#000" }, "frame4+=2.5")


		/*frame five*/
		.add("frame5", "frame4+=3")
		.to(".cta, .aw-logo, .funding-box", { autoAlpha: 1 }, "frame5")
